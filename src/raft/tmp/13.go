...
func (rf *Raft) GetLeaderId() (bool, int) {
	var isleader bool
	var leaderId int
...
func (rf *Raft) sendInstallSnapshot(server int) {
    ...
    if rf.isleader == false || args.Term != rf.currentTerm {
        rf.mu.Unlock()
        return
    }
...
func (rf *Raft) sendHeartbeat(server int, term int, me int) {
	args := HeartbeatArgs{}
